...
enemy1Image=loadImage("zombie.png");
enemy2Image=loadImage("zombie2.png");
enemy3Image=loadImage("zombie3.png");
backgroundImage=loadImage("forest[71].jpg");
bulletImage=loadImage("bullet.png");
bullet2Image=loadImage("bullet2.png");
introBG=loadImage("intro_bg.jpg");
gun1sound=loadSound("gun1.mp3");
gun2sound=loadSound("gun2.mp3");
}
